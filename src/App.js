...
import MarquerAbsence from './pages/enseignant/MarquerAbsence';
...
function App() {
  ...
  <div style={{style}} className="App">
    ...
    <Routes>
      ...
      <Route path='/enseignant/gestionEmplois' element={<GestionEmplois/>}/>
      <Route path='/enseignant/marquerAbsence' element={<MarquerAbsence/>}/>
    </Routes>
    </BrowserRouter>
    </div>
  );
