...
import SelectEmploi from "./elements/selectEmploi";
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 bg-gray-200 p-2 rounded-xl text-gray-400">
 ...
 <h1 className="text-blue-950 text-3xl mt-4 ml-10">Gestion des emplois</h1>

 <div className="text-xl p-10 bg-white  mt-6 space-y-6">
<SelectEmploi/>
<TimeTable/>
  </div>
