...
import TableTousEtudiant from "./elements/TableTousEtudiant";
    ...
    return ( 
        ...
        <div className="p-10 w-3/4">
           ...
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 bg-gray-200 p-2 rounded-xl text-gray-400">
            ...
            <h1 className="text-blue-950 text-3xl mt-4 ml-10">Gestion Groupes</h1>

            <div className="text-xl p-10 bg-white pr-44 mt-6 space-y-4">
               <h1 className="text-blue-500 mb-2">Choisir filière :</h1>
